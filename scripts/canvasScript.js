...
function showcontents(ix, jx) {
    if (a1[ix - 1][jx - 1] < 1000) {
        ...
        var temp = a1[ix - 1][jx - 1];
        a1[ix - 1][jx - 1] = 1000;
        if (temp == 0) {
            


            if ((ix) <= 8 && (jx + 1) <= 8 && (ix) >= 1 && (jx + 1) >= 1 && a1[ix - 1][jx] < 1000) {
                //if(a1[ix][jx - 2] == 0)
                //{
                showcontents(ix, jx + 1);
                //}
            }
            if ((ix) <= 8 && (jx - 1) <= 8 && (ix) >= 1 && (jx - 1) >= 1 && a1[ix - 1][jx - 2] < 1000) {
                //if(a
                showcontents(ix, jx - 1);
                //}
            }
            if ((ix - 1) <= 8 && (jx) <= 8 && (ix - 1) >= 1 && (jx) >= 1 && a1[ix - 2][jx - 1] < 1000) {
                //if(a1[ix - 1][jx] == 0)
                //{
                showcontents(ix - 1, jx);
                //}
            }
            if ((ix - 1) <= 8 && (jx + 1) <= 8 && (ix - 1) >= 1 && (jx + 1) >= 1 && a1[ix - 2][jx] < 1000) {
                //if(a1[ix - 1][jx - 2] == 0)
                //{

                showcontents(ix - 1, jx + 1);
                //}
            }
            if ((ix - 1) <= 8 && (jx - 1) <= 8 && (ix - 1) >= 1 && (jx - 1) >= 1 && a1[ix - 2][jx - 2] < 1000) {
                //if(a1[ix - 1][jx - 1] == 0)
                //{\
                showcontents(ix - 1, jx - 1);
                //}
            }
            if ((ix + 1) <= 8 && (jx + 1) <= 8 && (ix + 1) >= 1 && (jx + 1) >= 1 && a1[ix][jx] < 1000) {
                //if(a1[ix - 2][jx-2] == 0)
                //{
            ...
            if ((ix + 1) <= 8 && (jx - 1) <= 8 && (ix + 1) >= 1 && (jx - 1) >= 1 && a1[ix][jx - 2] < 1000) {
                //if(a1[ix - 2][jx - 1] == 0)
                //{
            ...
            if ((ix + 1) <= 8 && (jx) <= 8 && (ix + 1) >= 1 && (jx) >= 1 && a1[ix][jx - 1] < 1000) {
                //if(a1[ix - 2][jx] == 0)
                //{
        ...
        checked++;
        console.log("INCREMENTED FOR i = " + ix + " j =" + jx);
        if (checked == 54) {
            success();
        }
    }
